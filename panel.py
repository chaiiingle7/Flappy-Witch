...
font=pygame.font.Font('font/yoster.ttf', 50)

font_small=pygame.font.Font('font/yoster.ttf', 20)

panel=font.render("Game Panel", False, 'Gold')

game1=font_small.render("Flappy Witch", False, 'Gold')

background1=pygame.image.load('char/graveyard.jpeg').convert()
background=pygame.transform.scale(background1, (1000,500))

option1=pygame.image.load('char/option.png').convert_alpha()
option2=pygame.transform.scale(option1, (200,100))
option=option2.get_rect(topleft=(230,250))
...
while run:
    ...
    # screen.blit(panel, (370, 30))
    # screen.blit(option2, option)
    # screen.blit(game1, (200,250))

    # for events in pygame.event.get():
    #     if events.type==pygame.QUIT:
    #         run=False
    #     if events.type==pygame.MOUSEBUTTONDOWN:
    #         if option.collidepoint(mousepos):
    #             Flappy()
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if current== "menu":
                if option.collidepoint(mousepos):
                    current= "game" # Switch state!
            
            # If in game, handle exit button logic inside FlappyGame loop usually

    # 4. Logic for Game Screen
    if current == "game":
            screen=pygame.display.set_mode((1000,500))
